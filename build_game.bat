...
link.exe /nologo /SUBSYSTEM:WINDOWS /OUT:"build\bin\game.exe" ^
    ...
    "build\obj\combat_types.obj" "build\obj\attack_definitions.obj" "build\obj\player_progression.obj" "build\obj\equipment.obj" "build\obj\rewards.obj" "build\obj\reward_grants.obj" "build\obj\player_bank.obj" "build\obj\bank_overlay.obj" "build\obj\combat_system.obj" ^
    ...
    "build\obj\world_object_visual.obj" "build\obj\game_presentation.obj" "build\obj\game_session.obj" "build\obj\runtime_visual_sync.obj" ^

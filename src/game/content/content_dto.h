...
struct AuthoredProjectileDrop final { simulation::DefinitionId pickupId{}; std::uint32_t chancePercent{100}; };
struct AuthoredProjectileExplosion final { int damageAmount{}; int knockbackPixels{}; int radiusPixels{}; std::optional<simulation::DefinitionId> presentationEffectId{}; };
struct AuthoredProjectile final { simulation::DefinitionId id{}; simulation::DefinitionId visualId{}; gameplay::FacingDirection canonicalFacing{gameplay::FacingDirection::up}; int speedPixelsPerTick{}; std::uint32_t lifetimeTicks{}; int hitboxWidth{}; int hitboxHeight{}; gameplay::DirectionalOffsets spawnOffsets{}; gameplay::ProjectileRenderLayer renderLayer{gameplay::ProjectileRenderLayer::actor}; gameplay::DirectionalRenderLayers renderLayers{}; simulation::DefinitionId animationId{}; int maximumDistancePixels{}; simulation::DefinitionId impactAnimationId{}; simulation::DefinitionId expireAnimationId{}; gameplay::FacingDirection impactAnimationFacing{gameplay::FacingDirection::up}; gameplay::FacingDirection expireAnimationFacing{gameplay::FacingDirection::up}; gameplay::DirectionalAnimations expireAnimations{}; gameplay::DirectionalAnimations impactAnimations{}; gameplay::DirectionalFacings impactAnimationFacings{}; gameplay::DirectionalFacings expireAnimationFacings{}; std::array<bool, 4> flipX{}; std::array<bool, 4> impactFlipX{}; std::array<bool, 4> expireFlipX{}; std::optional<AuthoredProjectileDrop> expireDrop{}; std::optional<AuthoredProjectileDrop> impactDrop{}; std::optional<AuthoredProjectileExplosion> explosion{}; };

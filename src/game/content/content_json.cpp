...
const char* renderLayer(gameplay::ProjectileRenderLayer v){switch(v){case gameplay::ProjectileRenderLayer::world:return "world";case gameplay::ProjectileRenderLayer::actor:return "actor";}return "actor";}
...
JsonValue projectile(const AuthoredProjectile& v){JsonObject o;p(o,"id",id(v.id));p(o,"visualId",id(v.visualId));p(o,"canonicalFacing",S(facing(v.canonicalFacing)));p(o,"speedPixelsPerTick",I(v.speedPixelsPerTick));p(o,"lifetimeTicks",U(v.lifetimeTicks));p(o,"hitboxWidth",I(v.hitboxWidth));p(o,"hitboxHeight",I(v.hitboxHeight));p(o,"spawnOffsets",offsets(v.spawnOffsets));p(o,"renderLayer",S(renderLayer(v.renderLayer)));if(v.renderLayers.any()){JsonObject r;if(v.renderLayers.values[0])p(r,"down",S(renderLayer(*v.renderLayers.values[0])));if(v.renderLayers.values[1])p(r,"up",S(renderLayer(*v.renderLayers.values[1])));if(v.renderLayers.values[2])p(r,"left",S(renderLayer(*v.renderLayers.values[2])));if(v.renderLayers.values[3])p(r,"right",S(renderLayer(*v.renderLayers.values[3])));p(o,"renderLayers",O(std::move(r)));}if(!v.animationId.empty())p(o,"animationId",id(v.animationId));if(v.maximumDistancePixels>0)p(o,"maximumDistancePixels",U(v.maximumDistancePixels));if(!v.impactAnimationId.empty())p(o,"impactAnimationId",id(v.impactAnimationId));if(!v.expireAnimationId.empty())p(o,"expireAnimationId",id(v.expireAnimationId));if(v.impactAnimationFacing!=gameplay::FacingDirection::up)p(o,"impactAnimationFacing",S(facing(v.impactAnimationFacing)));if(v.expireAnimationFacing!=gameplay::FacingDirection::up)p(o,"expireAnimationFacing",S(facing(v.expireAnimationFacing)));if(std::any_of(v.flipX.begin(),v.flipX.end(),[](bool f){return f;})){JsonObject r;if(v.flipX[0])p(r,"down",B(true));if(v.flipX[1])p(r,"up",B(true));if(v.flipX[2])p(r,"left",B(true));if(v.flipX[3])p(r,"right",B(true));p(o,"flipX",O(std::move(r)));}if(v.expireAnimations.any()){JsonObject r;if(v.expireAnimations.values[0])p(r,"down",id(*v.expireAnimations.values[0]));if(v.expireAnimations.values[1])p(r,"up",id(*v.expireAnimations.values[1]));if(v.expireAnimations.values[2])p(r,"left",id(*v.expireAnimations.values[2]));if(v.expireAnimations.values[3])p(r,"right",id(*v.expireAnimations.values[3]));p(o,"expireAnimations",O(std::move(r)));}if(v.impactAnimations.any()){JsonObject r;if(v.impactAnimations.values[0])p(r,"down",id(*v.impactAnimations.values[0]));if(v.impactAnimations.values[1])p(r,"up",id(*v.impactAnimations.values[1]));if(v.impactAnimations.values[2])p(r,"left",id(*v.impactAnimations.values[2]));if(v.impactAnimations.values[3])p(r,"right",id(*v.impactAnimations.values[3]));p(o,"impactAnimations",O(std::move(r)));}if(v.impactAnimationFacings.any()){JsonObject r;if(v.impactAnimationFacings.values[0])p(r,"down",S(facing(*v.impactAnimationFacings.values[0])));if(v.impactAnimationFacings.values[1])p(r,"up",S(facing(*v.impactAnimationFacings.values[1])));if(v.impactAnimationFacings.values[2])p(r,"left",S(facing(*v.impactAnimationFacings.values[2])));if(v.impactAnimationFacings.values[3])p(r,"right",S(facing(*v.impactAnimationFacings.values[3])));p(o,"impactAnimationFacings",O(std::move(r)));}if(v.expireAnimationFacings.any()){JsonObject r;if(v.expireAnimationFacings.values[0])p(r,"down",S(facing(*v.expireAnimationFacings.values[0])));if(v.expireAnimationFacings.values[1])p(r,"up",S(facing(*v.expireAnimationFacings.values[1])));if(v.expireAnimationFacings.values[2])p(r,"left",S(facing(*v.expireAnimationFacings.values[2])));if(v.expireAnimationFacings.values[3])p(r,"right",S(facing(*v.expireAnimationFacings.values[3])));p(o,"expireAnimationFacings",O(std::move(r)));}return O(std::move(o));}
...
JsonValue tileCollision(const AuthoredTileCollision& v){JsonObject o;p(o,"sourceIndex",U(v.sourceIndex));p(o,"width",U(v.width));p(o,"height",U(v.height));p(o,"cells",arrayOf(v.cells,[](auto x){return U(x);}));return O(std::move(o));}
...
JsonValue directional(const presentation::DirectionalAnimationRef& v){JsonObject o;if(v.defaultAnimation)p(o,"default",id(*v.defaultAnimation));if(v.down)p(o,"down",id(*v.down));if(v.up)p(o,"up",id(*v.up));if(v.left)p(o,"left",id(*v.left));if(v.right)p(o,"right",id(*v.right));if(v.side&&!v.left&&!v.right)p(o,"side",id(*v.side));return O(std::move(o));}
...
JsonValue animationFrameMask(const AuthoredAnimationFrameMask& v){JsonObject o;p(o,"channel",S(v.channel));p(o,"width",U(v.width));p(o,"height",U(v.height));p(o,"origin",point(v.origin));p(o,"cells",arrayOf(v.cells,[](auto x){return U(x);}));return O(std::move(o));}
JsonValue animation(const AuthoredAnimation& v){JsonObject o;p(o,"id",id(v.id));p(o,"imageId",id(v.imageId));p(o,"loop",B(v.loop));p(o,"frames",arrayOf(v.frames,[](const auto& f){JsonObject q;p(q,"source",rect(f.source));p(q,"anchor",point(f.anchor));p(q,"drawOffset",point(f.drawOffset));p(q,"durationTicks",U(f.durationTicks));p(q,"markers",strings(f.markers));if(f.flipX)p(q,"flipX",B(true));if(!f.masks.empty())p(q,"masks",arrayOf(f.masks,animationFrameMask));return O(std::move(q));}));return O(std::move(o));}
JsonValue playerMovementCollision(const AuthoredPlayerMovementCollision& v){JsonObject o;p(o,"down",objectCollision(v.down));p(o,"up",objectCollision(v.up));p(o,"left",objectCollision(v.left));p(o,"right",objectCollision(v.right));return O(std::move(o));}
JsonValue playerDef(const AuthoredPlayer& v){JsonObject o;p(o,"id",id(v.id));p(o,"visualSetId",id(v.visualSetId));p(o,"progressionId",id(v.progressionId));if(v.movementCollision)p(o,"movementCollision",playerMovementCollision(*v.movementCollision));if(v.hurtbox)p(o,"hurtbox",objectCollision(*v.hurtbox));return O(std::move(o));}

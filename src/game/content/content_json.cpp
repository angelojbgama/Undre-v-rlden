...
JsonValue playerDef(const AuthoredPlayer& v){JsonObject o;p(o,"id",id(v.id));p(o,"visualSetId",id(v.visualSetId));p(o,"progressionId",id(v.progressionId));return O(std::move(o));}

...
private:
    ...
    void keyDown(WPARAM key) { modifiers(); if (input_.control && key == 'D') input_.duplicatePressed = true; else if (input_.control && key == 'Z') input_.undoPressed = true; else if (input_.control && key == 'Y') input_.redoPressed = true; else if (input_.control && key == 'N') menuCommand(fileNew); else if (input_.control && key == 'O') menuCommand(fileOpen); else if (input_.control && key == 'S') menuCommand(fileSave); else if (key == 'W' || key == VK_UP) input_.up = true; else if (key == 'S' || key == VK_DOWN) input_.down = true; else if (key == 'A') input_.left = true; else if (key == 'D') input_.right = true; else if (key == VK_LEFT) { input_.left = true; input_.leftPressed = true; } else if (key == VK_RIGHT) { input_.right = true; input_.rightPressed = true; } else if (key == VK_SPACE) input_.space = true; else if (key == VK_DELETE) input_.deletePressed = true; else if (key == VK_HOME) input_.homePressed = true; else if (key == VK_END) input_.endPressed = true; else if (key == VK_RETURN) input_.enterPressed = true; else if (key == VK_ESCAPE) input_.escapePressed = true; else if (key == VK_BACK) input_.backspacePressed = true; }
    ...
    void clearEdges() { input_.pointer.leftPressed = false; input_.pointer.leftReleased = false; input_.pointer.middlePressed = false; input_.pointer.middleReleased = false; input_.pointer.wheelDelta = 0; input_.deletePressed = false; input_.duplicatePressed = false; input_.undoPressed = false; input_.redoPressed = false; input_.homePressed = false; input_.endPressed = false; input_.leftPressed = false; input_.rightPressed = false; input_.enterPressed = false; input_.escapePressed = false; input_.backspacePressed = false; input_.focusLost = false; input_.previewTicks = 0; input_.textInput.clear(); }

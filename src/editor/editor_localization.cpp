...
constexpr std::array entries{
    ...
    Entry{EditorTextId::newMapAction,"New Map","Novo Mapa"},
    ...
    Entry{EditorTextId::dragToReorder,"Drag to reorder","Arraste para reordenar"},
    Entry{EditorTextId::showLayer,"Show layer","Mostrar camada"},
    Entry{EditorTextId::hideLayer,"Hide layer","Ocultar camada"},
    Entry{EditorTextId::lockLayer,"Lock layer","Bloquear camada"},
    Entry{EditorTextId::unlockLayer,"Unlock layer","Desbloquear camada"},
    Entry{EditorTextId::addLayer,"Add layer","Adicionar camada"},
    Entry{EditorTextId::removeLayer,"Remove layer","Remover camada"},
    ...
    Entry{EditorTextId::persistence,"PERSISTENCE","PERSISTÊNCIA"}, Entry{EditorTextId::persistent,"Persistent","Persistente"},
    Entry{EditorTextId::resetOnMapEnter,"Reset On Map Enter","Reiniciar ao entrar no mapa"},
    Entry{EditorTextId::persistentDescription,"Changes to this instance survive map changes and are stored in the save.","As alterações desta instância permanecem ao trocar de mapa e são armazenadas no save."},
    Entry{EditorTextId::resetOnMapEnterDescription,"The authored initial state is restored when this map is loaded again.","A instância retorna ao estado inicial definido no mapa quando este mapa é carregado novamente."},
    Entry{EditorTextId::containerResetWarning,"Warning: This container returns to its initial contents when the player leaves and re-enters this map.","Aviso: Este contêiner retornará ao conteúdo inicial quando o jogador sair e entrar novamente neste mapa."},
    Entry{EditorTextId::destructibleResetWarning,"Warning: This object returns to its initial state when this map is loaded again.","Aviso: Este objeto reaparecerá no estado inicial quando o mapa for carregado novamente."},
    ...
    Entry{EditorTextId::maps,"Maps","MAPAS"}, Entry{EditorTextId::scenes,"SCENES","CENAS"}, Entry{EditorTextId::newProject,"New Project","Novo Projeto"},
...
const std::vector<EditorTextId>& EditorLocalization::allTextIds() noexcept {
    static const std::vector<EditorTextId> ids{
        ...
        EditorTextId::language, EditorTextId::newMap, EditorTextId::newMapAction, EditorTextId::openMap, EditorTextId::save,
        ...
        EditorTextId::remove, EditorTextId::dragToReorder, EditorTextId::showLayer,
        EditorTextId::hideLayer, EditorTextId::lockLayer, EditorTextId::unlockLayer,
        EditorTextId::addLayer, EditorTextId::removeLayer, EditorTextId::moveUp,
        EditorTextId::moveDown, EditorTextId::open,
        ...
        EditorTextId::persistence, EditorTextId::persistent, EditorTextId::resetOnMapEnter,
        EditorTextId::persistentDescription, EditorTextId::resetOnMapEnterDescription,
        EditorTextId::containerResetWarning, EditorTextId::destructibleResetWarning,
        ...
        EditorTextId::languageEnglish, EditorTextId::maps, EditorTextId::scenes, EditorTextId::newProject,

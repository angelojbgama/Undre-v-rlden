...
ALL_OBJECTS := $(COMMON_OBJECTS) $(GAME_OBJECT) $(RUNNER_OBJECT) $(CONTENT_CHECK_OBJECT) $(MAP_COMPILE_OBJECT) $(TEST_OBJECT) $(LINUX_OBJECTS)
DEP_FILES := $(ALL_OBJECTS:.o=.d)

.PHONY: all build tests playtest game content_check map_compile clean

all: tests playtest game content_check
build: all
...
clean:
	rm -rf $(OBJ_DIR) $(BUILD_DIR)/tests $(BUILD_DIR)/playtest_runner $(BUILD_DIR)/game $(BUILD_DIR)/content_check $(BUILD_DIR)/map_compile

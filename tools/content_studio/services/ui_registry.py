...
BINDING_PATHS: tuple[str, ...] = (
    ...
    "context.craft.line",
    "context.book.line",
    "overlay.crafting.rowSelected",
    "overlay.crafting.bookRowSelected",
    "overlay.crafting.tabCraft",
    "overlay.crafting.tabBook",
    "crafting.ingredient0",
    "crafting.ingredient1",
    "crafting.ingredient2",
    "crafting.ingredient3",
    "crafting.outputLine",
    "crafting.qtyLine",
    "crafting.feedbackLine",
    "context.index",
    "context.item.id",
    "context.item.icon",
    "context.item.amount",

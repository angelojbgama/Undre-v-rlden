...
TRANSLATIONS["pt-BR"].update({
    "ui_mode": "UI",
    "ui_composer_screens": "Telas",
    "ui_composer_add_screen": "+ Tela",
    "ui_composer_remove_screen": "- Tela",
    "ui_composer_hierarchy": "Hierarquia",
    "ui_composer_add_node": "+ Nó",
    "ui_composer_remove_node": "- Nó",
    "ui_composer_validation": "Validação da tela",
    "ui_composer_preview_hint": "Dados de preview (não são salvos)",
    "ui_composer_select_node": "Selecione um nó na hierarquia",
    "ui_composer_component": "Componente",
    "ui_composer_anchor": "Âncora",
    "ui_composer_offset": "Offset X / Y",
    "ui_composer_size": "Largura / Altura (0 = auto)",
    "ui_composer_sprite": "Sprite (staticSprites)",
    "ui_composer_frame": "Moldura 9-slice",
    "ui_composer_animation": "Animação (animations)",
    "ui_composer_text": "Texto literal",
    "ui_composer_meter_mode": "Modo do medidor",
    "ui_composer_meter_sprites": "Sprites (full: id / fill: id)",
    "ui_composer_meter_spacing": "Espaçamento",
    "ui_composer_bindings": "Bindings",
    "ui_composer_new_binding": "Nova ligação",
    "ui_composer_bind": "Vincular",
    "ui_composer_unbind": "Desvincular",
    "ui_composer_states": "Estados",
    "ui_composer_new_state": "Novo estado",
    "ui_composer_state_id": "Id do estado",
    "ui_composer_state_threshold": "Limite (%)",
    "ui_composer_add_state": "+ Estado",
    "ui_composer_remove_state": "- Estado",
    "ui_composer_actions": "Ações",
    "ui_composer_new_action": "+ Ação",
    "ui_composer_new_screen": "Nova tela",
    "ui_composer_screen_id": "Id da tela",
...
TRANSLATIONS.setdefault("en-US", {}).update({
    "ui_mode": "UI",
    "ui_composer_screens": "Screens",
    "ui_composer_add_screen": "+ Screen",
    "ui_composer_remove_screen": "- Screen",
    "ui_composer_hierarchy": "Hierarchy",
    "ui_composer_add_node": "+ Node",
    "ui_composer_remove_node": "- Node",
    "ui_composer_validation": "Screen validation",
    "ui_composer_preview_hint": "Preview data (never saved)",
    "ui_composer_select_node": "Select a node in the hierarchy",
    "ui_composer_component": "Component",
    "ui_composer_anchor": "Anchor",
    "ui_composer_offset": "Offset X / Y",
    "ui_composer_size": "Width / Height (0 = auto)",
    "ui_composer_sprite": "Sprite (staticSprites)",
    "ui_composer_frame": "9-slice frame",
    "ui_composer_animation": "Animation (animations)",
    "ui_composer_text": "Literal text",
    "ui_composer_meter_mode": "Meter mode",
    "ui_composer_meter_sprites": "Sprites (full: id / fill: id)",
    "ui_composer_meter_spacing": "Spacing",
    "ui_composer_bindings": "Bindings",
    "ui_composer_new_binding": "New binding",
    "ui_composer_bind": "Bind",
    "ui_composer_unbind": "Unbind",
    "ui_composer_states": "States",
    "ui_composer_new_state": "New state",
    "ui_composer_state_id": "State id",
    "ui_composer_state_threshold": "Threshold (%)",
    "ui_composer_add_state": "+ State",
    "ui_composer_remove_state": "- State",
    "ui_composer_actions": "Actions",
    "ui_composer_new_action": "+ Action",
    "ui_composer_new_screen": "New screen",
    "ui_composer_screen_id": "Screen id",
...
TRANSLATIONS["pt-BR"].update({
    ...
    "enemies_tab": "Inimigos",
    "enemy_search": "Buscar inimigos...",
    "enemy_create": "Criar inimigo",
    "enemy_configure": "Editar inimigo",
    "enemy_delete": "Excluir inimigo",
    "enemy_delete_confirm": "Excluir o inimigo \"{enemy}\"?",
    "enemy_none": "Nenhum inimigo selecionado. Crie um para começar (visual + comportamento + ataque).",
    "enemy_created": "Inimigo criado",
    "enemy_configured": "Inimigo editado",
    "enemy_deleted": "Inimigo excluído",
    "enemy_placed_in": "Posicionado nos mapas",
    "enemy_field_id": "Id",
    "enemy_field_visual": "Visual (conjunto)",
    "enemy_field_behavior": "Comportamento",
    "enemy_field_health": "Vida máxima",
    "enemy_field_speed": "Velocidade (subpx/tick)",
    "enemy_field_collision": "Corpo de colisão",
    "enemy_field_hurtbox": "Hurtbox",
    "enemy_field_attacks": "Ataques",
    "enemy_field_reward": "Recompensa (perfil)",
    "enemy_visual_ok": "Sprites verificados: nenhum problema encontrado.",
    "enemy_visual_problems": "Verificação de sprites: {count} problema(s) encontrado(s).",
    "npcs_tab": "NPCs",
    "npc_search": "Buscar NPCs...",
    "npc_create": "Criar NPC",
    "npc_configure": "Editar NPC",
    "npc_delete": "Excluir NPC",
    "npc_delete_confirm": "Excluir o NPC \"{npc}\"?",
    "npc_none": "Nenhum NPC selecionado. Crie um para começar (visual + diálogo).",
    "npc_created": "NPC criado",
    "npc_configured": "NPC editado",
    "npc_deleted": "NPC excluído",
    "npc_placed_in": "Posicionado nos mapas",
    "npc_field_id": "Id",
    "npc_field_visual": "Visual (conjunto)",
    "npc_field_dialogue": "Diálogo padrão",
    "npc_field_interaction": "Área de interação",
    "npc_field_enabled": "Interação habilitada",
    "npc_field_tags": "Tags",
    "npc_visual_ok": "Sprites verificados: nenhum problema encontrado.",
    "npc_visual_problems": "Verificação de sprites: {count} problema(s) encontrado(s).",
    "npc_visual_edit": "Editar visual do NPC",
    "npc_visual_create": "Novo visual de NPC",
    "npc_visual_field_id": "Id do visual",
    "npc_visual_field_marker": "Cor do marcador",
    "npc_visual_field_default": "Animação padrão",
    "npc_visual_hint": "Preencha a animação padrão OU os facings (down/up/left/right). Sem animações, o NPC aparece no jogo como um retângulo na cor do marcador.",
    "npc_import_sheet": "Importar spritesheet...",
    "npc_sequences_group": "Sequências de frames",
    "npc_sequence_empty": "Vazia — clique em Montar frames.",
    "npc_sequence_edit": "Montar frames...",
    "npc_sequence_clear": "Limpar",
    "npc_sequence_summary": "{frames} frames ({size}) de {image}",
    "dialogues_tab": "Diálogos",
    "dialogue_search": "Buscar diálogos...",
    "dialogue_create": "Criar diálogo",
    "dialogue_configure": "Editar diálogo",
    "dialogue_delete": "Excluir diálogo",
    "dialogue_delete_confirm": "Excluir o diálogo \"{dialogue}\"?",
    "dialogue_none": "Nenhum diálogo selecionado. Crie um e ligue-o a um NPC.",
    "dialogue_created": "Diálogo criado",
    "dialogue_configured": "Diálogo editado",
    "dialogue_deleted": "Diálogo excluído",
    "dialogue_open_library": "Diálogos...",
    "dialogue_library_title": "Biblioteca de diálogos",
    "dialogue_close": "Fechar",
    "dialogue_editor_title": "Editor de diálogo",
    "dialogue_nodes_label": "Nós",
    "dialogue_add_node": "Adicionar nó",
    "dialogue_remove_node": "Remover nó",
    "dialogue_apply_node": "Aplicar mudanças do nó",
    "dialogue_duplicate_node": "Já existe um nó com esse id.",
    "dialogue_last_node": "O diálogo precisa de pelo menos um nó.",
    "dialogue_pages_hint": "Uma página por linha",
    "dialogue_next_end": "— fim do diálogo —",
    "dialogue_field_id": "Id",
    "dialogue_field_node_id": "Id do nó",
    "dialogue_field_speaker": "Falante",
    "dialogue_field_pages": "Páginas",
    "dialogue_field_next": "Próximo nó",
    "dialogue_field_choices": "Decisões (choices)",
    "dialogue_field_label": "Rótulo",
    "dialogue_field_target": "Nó de destino",
    "dialogue_field_kind": "Tipo",
    "dialogue_field_flag": "Flag",
    "dialogue_field_quest": "Quest",
    "dialogue_field_shop": "Loja",
    "dialogue_choices_group": "Decisões",
    "dialogue_conditions_group": "Condições de visibilidade",
    "dialogue_actions_group": "Ações ao escolher",
    "dialogue_condition_title": "Condição",
    "dialogue_action_title": "Ação",
    "dialogue_choice_title": "Decisão",
    "dialogue_add": "Adicionar",
    "dialogue_edit": "Editar",
    "dialogue_remove": "Remover",
    "dialogue_quests_started": "Quests iniciadas por este diálogo",
    "dialogue_shops_opened": "Lojas abertas por este diálogo",
    "playtest_exited": "Playtest encerrado",
    "playtest_crashed": "Playtest encerrado com código {code}",
    "autosave_recovery_title": "Recuperação de autosave",
    "autosave_recovery_question": "Existe um autosave mais recente que o arquivo salvo \"{path}\". Restaurar o autosave? (Escolher \"No\" abre o arquivo salvo e mantém o autosave.)",
    "autosave_restored": "Autosave restaurado para {path}",
    "definition_in_use": "\"{definition_id}\" ainda é referenciado por: {usages}. Resolva as referências antes de excluir.",
...
TRANSLATIONS["en-US"].update({
    ...
    "enemies_tab": "Enemies",
    "enemy_search": "Search enemies...",
    "enemy_create": "Create enemy",
    "enemy_configure": "Edit enemy",
    "enemy_delete": "Delete enemy",
    "enemy_delete_confirm": "Delete enemy \"{enemy}\"?",
    "enemy_none": "No enemy selected. Create one to start (visual + behavior + attack).",
    "enemy_created": "Enemy created",
    "enemy_configured": "Enemy edited",
    "enemy_deleted": "Enemy deleted",
    "enemy_placed_in": "Placed in maps",
    "enemy_field_id": "Id",
    "enemy_field_visual": "Visual (set)",
    "enemy_field_behavior": "Behavior",
    "enemy_field_health": "Maximum health",
    "enemy_field_speed": "Speed (subpx/tick)",
    "enemy_field_collision": "Collision body",
    "enemy_field_hurtbox": "Hurtbox",
    "enemy_field_attacks": "Attacks",
    "enemy_field_reward": "Reward (profile)",
    "enemy_visual_ok": "Sprites verified: no problems found.",
    "enemy_visual_problems": "Sprite verification: {count} problem(s) found.",
    "npcs_tab": "NPCs",
    "npc_search": "Search NPCs...",
    "npc_create": "Create NPC",
    "npc_configure": "Edit NPC",
    "npc_delete": "Delete NPC",
    "npc_delete_confirm": "Delete NPC \"{npc}\"?",
    "npc_none": "No NPC selected. Create one to start (visual + dialogue).",
    "npc_created": "NPC created",
    "npc_configured": "NPC edited",
    "npc_deleted": "NPC deleted",
    "npc_placed_in": "Placed in maps",
    "npc_field_id": "Id",
    "npc_field_visual": "Visual (set)",
    "npc_field_dialogue": "Default dialogue",
    "npc_field_interaction": "Interaction area",
    "npc_field_enabled": "Interaction enabled",
    "npc_field_tags": "Tags",
    "npc_visual_ok": "Sprites verified: no problems found.",
    "npc_visual_problems": "Sprite verification: {count} problem(s) found.",
    "npc_visual_edit": "Edit NPC visual",
    "npc_visual_create": "New NPC visual",
    "npc_visual_field_id": "Visual id",
    "npc_visual_field_marker": "Marker color",
    "npc_visual_field_default": "Default animation",
    "npc_visual_hint": "Fill the default animation OR the facings (down/up/left/right). With no animations the NPC renders in game as a marker-colored rectangle.",
    "npc_import_sheet": "Import spritesheet...",
    "npc_sequences_group": "Frame sequences",
    "npc_sequence_empty": "Empty — click Build frames.",
    "npc_sequence_edit": "Build frames...",
    "npc_sequence_clear": "Clear",
    "npc_sequence_summary": "{frames} frames ({size}) from {image}",
    "dialogues_tab": "Dialogues",
    "dialogue_search": "Search dialogues...",
    "dialogue_create": "Create dialogue",
    "dialogue_configure": "Edit dialogue",
    "dialogue_delete": "Delete dialogue",
    "dialogue_delete_confirm": "Delete dialogue \"{dialogue}\"?",
    "dialogue_none": "No dialogue selected. Create one and link it to an NPC.",
    "dialogue_created": "Dialogue created",
    "dialogue_configured": "Dialogue edited",
    "dialogue_deleted": "Dialogue deleted",
    "dialogue_open_library": "Dialogues...",
    "dialogue_library_title": "Dialogue library",
    "dialogue_close": "Close",
    "dialogue_editor_title": "Dialogue editor",
    "dialogue_nodes_label": "Nodes",
    "dialogue_add_node": "Add node",
    "dialogue_remove_node": "Remove node",
    "dialogue_apply_node": "Apply node changes",
    "dialogue_duplicate_node": "A node with this id already exists.",
    "dialogue_last_node": "The dialogue needs at least one node.",
    "dialogue_pages_hint": "One page per line",
    "dialogue_next_end": "— end of dialogue —",
    "dialogue_field_id": "Id",
    "dialogue_field_node_id": "Node id",
    "dialogue_field_speaker": "Speaker",
    "dialogue_field_pages": "Pages",
    "dialogue_field_next": "Next node",
    "dialogue_field_choices": "Decisions (choices)",
    "dialogue_field_label": "Label",
    "dialogue_field_target": "Target node",
    "dialogue_field_kind": "Kind",
    "dialogue_field_flag": "Flag",
    "dialogue_field_quest": "Quest",
    "dialogue_field_shop": "Shop",
    "dialogue_choices_group": "Choices",
    "dialogue_conditions_group": "Visibility conditions",
    "dialogue_actions_group": "Actions on choose",
    "dialogue_condition_title": "Condition",
    "dialogue_action_title": "Action",
    "dialogue_choice_title": "Choice",
    "dialogue_add": "Add",
    "dialogue_edit": "Edit",
    "dialogue_remove": "Remove",
    "dialogue_quests_started": "Quests started by this dialogue",
    "dialogue_shops_opened": "Shops opened by this dialogue",
    "playtest_exited": "Playtest finished",
    "playtest_crashed": "Playtest game exited with code {code}",
    "autosave_recovery_title": "Autosave recovery",
    "autosave_recovery_question": "An autosave newer than the saved file \"{path}\" exists. Restore the autosave? (Choosing \"No\" opens the saved file and keeps the autosave.)",
    "autosave_restored": "Autosave restored to {path}",
    "definition_in_use": "\"{definition_id}\" is still referenced by: {usages}. Resolve the references before deleting.",
...
TRANSLATIONS["pt-BR"].update({
    ...
    "app_icon": "Ícone do jogo...",
    "app_icon_done": "Ícone gerado em {ico}. Rode build.bat para embutir no game.exe.",
    "app_icon_failed": "Não foi possível gerar o ícone.",
...
TRANSLATIONS["en-US"].update({
    ...
    "app_icon": "Game icon...",
    "app_icon_done": "Icon written to {ico}. Run build.bat to embed it into game.exe.",
    "app_icon_failed": "Could not generate the icon.",

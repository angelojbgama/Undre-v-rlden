...
class ObjectDefinitionDialog(QDialog):
    ...
    def __init__(self, workspace: ContentWorkspace, translator: Translator,
        ...
        self.example_caption.setProperty("muted", True)
        ...
        scenery_hint.setWordWrap(True); scenery_hint.setProperty("muted", True)
        ...
        reward_hint.setWordWrap(True); reward_hint.setProperty("muted", True)
        ...
        destructible_hint.setProperty("muted", True)
        ...
        chest_hint.setWordWrap(True); chest_hint.setProperty("muted", True)
        ...
        collision_hint.setWordWrap(True); collision_hint.setProperty("muted", True)
        ...
        depth_hint.setWordWrap(True); depth_hint.setProperty("muted", True)

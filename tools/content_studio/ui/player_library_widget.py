...
class FrameSequenceDialog(QDialog):
    ...
    def __init__(self, workspace: ContentWorkspace, asset_root: Path | None,
        ...
        add_button.setIcon(icon("add"))
        remove_button = QPushButton("Remover")
        remove_button.setIcon(icon("delete"))
        up_button = QPushButton()
        up_button.setIcon(icon("move_up"))
        up_button.setToolTip(self.translate("move_up"))
        down_button = QPushButton()
        down_button.setIcon(icon("move_down"))
        down_button.setToolTip(self.translate("move_down"))
        clear_button = QPushButton("Limpar")
        clear_button.setIcon(icon("close"))
